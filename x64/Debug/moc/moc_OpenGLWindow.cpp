...
Q_CONSTINIT static const qt_meta_stringdata_CLASSOpenGLWindowENDCLASS_t qt_meta_stringdata_CLASSOpenGLWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 12),  // "update_state"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "OpenGLWindow",
    "update_state",
...
void OpenGLWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &OpenGLWindow::update_state; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OpenGLWindow::update_state()
{
